...
var ChatAgent = class ChatAgent extends require_agent.Agent {
	...
	*/
	static createPrompt(tools, args) {
		...
		const messages = [_langchain_core_prompts.SystemMessagePromptTemplate.fromTemplate(template), _langchain_core_prompts.HumanMessagePromptTemplate.fromTemplate(humanMessageTemplate)];
