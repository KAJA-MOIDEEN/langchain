	...
	*/
	...
	constructor(input) {
		...
		if (_langchain_core_runnables.Runnable.isRunnable(input.agent)) {
			if (require_agent.AgentRunnableSequence.isAgentRunnableSequence(input.agent)) {
				if (input.agent.singleAction) agent = new require_agent.RunnableSingleActionAgent({
