...
var ZeroShotAgent = class ZeroShotAgent extends require_agent.Agent {
	...
	*/
	static createPrompt(tools, args) {
		...
		const template = [
			prefix,
			toolStrings,
			(0, _langchain_core_prompts.renderTemplate)(require_prompt.FORMAT_INSTRUCTIONS, "f-string", { tool_names: toolNames }),
			suffix
		].join("\n\n");
	...
	*/
	...
	static async deserialize(data) {
		...
		return require_helpers.deserializeHelper(llm, tools, rest, (llm, tools, args) => ZeroShotAgent.fromLLMAndTools(llm, tools, {
			prefix: args.prefix,
			suffix: args.suffix,
