...
*/
var RequestsToolkit = class extends _langchain_core_tools.BaseToolkit {
	tools;
	constructor(headers) {
		super();
...
var OpenApiToolkit = class extends RequestsToolkit {
	constructor(jsonSpec, llm, headers) {
		...
		this.tools = [...this.tools, new _langchain_core_tools.DynamicTool({
			name: "json_explorer",
			func: async (input) => {
				return (await jsonAgent.call({ input })).output;
			},
