...
var ChatVectorDBQAChain = class ChatVectorDBQAChain extends require_base.BaseChain {
	...
	*/
	static fromLLM(llm, vectorstore, options = {}) {
		...
		const question_generator_prompt = _langchain_core_prompts.PromptTemplate.fromTemplate(questionGeneratorTemplate || question_generator_template);
		const qa_prompt = _langchain_core_prompts.PromptTemplate.fromTemplate(qaTemplate || qa_template);
