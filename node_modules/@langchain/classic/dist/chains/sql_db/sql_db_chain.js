...
var SqlDatabaseChain = class extends BaseChain {
	...
	*/
	async verifyNumberOfTokens(inputText, tableinfo) {
		...
		if (await calculateMaxTokens({
			prompt: stringWeSend,
			modelName: llm.model
		}) < (llm.maxTokens ?? -1)) throw new Error(`The combination of the database structure and your question is too big for the model ${llm.model} which can compute only a max tokens of ${getModelContextSize(llm.model)}.
