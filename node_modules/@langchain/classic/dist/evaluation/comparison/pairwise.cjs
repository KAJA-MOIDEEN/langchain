...
*/
var PairwiseStringResultOutputParser = class extends _langchain_core_output_parsers.BaseLLMOutputParser {
	static lc_name() {
...
*/
var PairwiseStringEvalChain = class extends require_base.LLMPairwiseStringEvaluator {
	static lc_name() {
...
To use references, use the LabeledPairwiseStringEvalChain instead.`;
	...
	static resolvePairwisePrompt(prompt) {
		const _prompt = prompt || require_prompt.PROMPT;
		const expectedInputVars = /* @__PURE__ */ new Set([
			"prediction",
			"predictionB",
			"input",
			"criteria"
