...
var MemoryVectorStore = class MemoryVectorStore extends VectorStore {
	...
	*/
	async similaritySearchVectorWithScore(query, k, filter) {
		return (await this._queryVectors(query, k, filter)).map((search) => [new Document({
	...
	async maxMarginalRelevanceSearch(query, options) {
		...
		return maximalMarginalRelevance(queryEmbedding, embeddingList, options.lambda, options.k).map((idx) => new Document({
